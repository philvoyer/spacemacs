...
(defun dotspacemacs/layers ()
  ...
  (setq-default
    ...
    '(
       ...
       (lsp :variables lsp-symbol-highlighting-delay 1.0)
       (lsp :variables lsp-lens-enable nil)
       (lsp :variables lsp-signature-auto-activate t)
       (lsp :variables lsp-idle-delay 3.0)
       (lsp :variables lsp-ui-sideline-delay 5.0)
       (lsp :variables lsp-ui-sideline-enable nil)
       (lsp :variables lsp-ui-sideline-show-code-actions nil)
       (lsp :variables lsp-ui-sideline-show-hover nil)
       (lsp :variables lsp-ui-sideline-show-diagnostics nil)
       (lsp :variables lsp-ui-doc-enable nil)
       (lsp :variables lsp-ui-doc-show-with-cursor nil)
       (lsp :variables lsp-ui-doc-show-with-mouse t)
       (lsp :variables flycheck-display-errors-function nil)
